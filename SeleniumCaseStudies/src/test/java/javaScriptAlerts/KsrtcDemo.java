...
public class KsrtcDemo {
	    ...
	    public void TestPopups() throws Exception {
	        ...
	        driver.findElement(By.xpath("//div[contains(@class,'payee-info-inputs')]//div[contains(@class,'inp-container')][1]//input")).clear();

	        driver.findElement(By.xpath("(//div[contains(@class,'auth-page')]//*[normalize-space()='Login'])[last()]")).click();
	        Thread.sleep(1000);
	        ...
	        driver.findElement(By.xpath("//div[contains(@class,'alert')]//*[normalize-space()='OK']")).click();
	        Thread.sleep(1000);

	        
	        driver.findElement(By.xpath("//div[contains(@class,'payee-info-inputs')]//div[contains(@class,'inp-container')][1]//input")).sendKeys("kkirthi@gmail.com");	                	               
	        driver.findElement(By.xpath("//div[contains(@class,'payee-info-inputs')]//div[contains(@class,'inp-container')][3]//input")).clear();	                	                
	        driver.findElement(By.xpath("(//div[contains(@class,'auth-page')]//*[normalize-space()='Login'])[last()]")).click();	                	                
	        Thread.sleep(1000);
	        ...
	        driver.findElement(By.xpath("//div[contains(@class,'payee-info-inputs')]//div[contains(@class,'inp-container')][3]//input")).sendKeys("8074316435");
	        driver.findElement(By.xpath("//div[contains(@class,'payee-info-inputs')]//div[contains(@class,'inp-container')][4]//input")).clear();
	        driver.findElement(By.xpath("(//div[contains(@class,'auth-page')]//*[normalize-space()='Login'])[last()]")).click();   
	        Thread.sleep(1000);
	        ...
	        driver.findElement(By.xpath( "//div[contains(@class,'payee-info-inputs')]//div[contains(@class,'inp-container')][4]//input")).sendKeys("wrongpassword");	             
	        driver.findElement(By.xpath("(//div[contains(@class,'auth-page')]//*[normalize-space()='Login'])[last()]")).click();
